               ...
               <%-- <div class="layui-inline">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="unable" id="unable" lay-filter="aihao">
                                <option value=""></option>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    <a class="menu-btn"></a>
                    <div class="l-list">
                        <a class="layui-btn layui-btn-small do-action" data-type="doAddEdit" data-href="${carAddUrl}"><i
                       ...
                       <%-- <td><a href="javascript:;" onclick="seeDesc('{{ item.id }}','{{ item.name}}')">查看详情</a></td>--%>
                        <%--'商品详情的存储字段',--%>
                           <%-- <a class="layui-btn layui-btn-small layui-btn-danger do-action" data-type="doDelete"
                               data-text="确定删除<span class=red>{{item.name}}</span>吗？"
                        ...
                        <a class="layui-btn layui-btn-small do-action" data-type="doAndRefresh"
                           data-href="/car/isanable?unable=1&ids={{item.id}}"><i
                                class="icon-edit  fa fa-pencil-square-o"></i>通过</a>
                        <a class="layui-btn layui-btn-small do-action" data-type="doAndRefresh"
                           data-href="/car/isanable?unable=2&ids={{item.id}}"><i
                                class="icon-edit  fa fa-pencil-square-o"></i>不通过</a>
                            {{# } else { }}
                        <a class="layui-btn layui-btn-small do-action" data-type="doAndRefresh"
                           data-href="/car/isanable?unable=1&ids={{item.id}}"><i
                                class="icon-edit  fa fa-pencil-square-o"></i>通过</a>
