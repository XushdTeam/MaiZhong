    ...
    <div class="site-text site-block">
        <form class="layui-form layui-form-pane" >
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select lay-verify="required" name="parent">
                        <option <c:if test="${menu.parent==0}">selected="selected"</c:if>  value="0">无节点,我是父节点</option>
                ...
                <div class="layui-input-block">
                    <select lay-verify="required" name="menuType">
                        ...
                        <c:forEach var="item" items="${dicList}">
                            <option value="${item.id}" <c:if test="${item.id==menu.menuType}">selected="selected"</c:if>>${item.dicName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="sort" autocomplete="off" value="${menu.sort}" min="0" lay-verify="required" placeholder="数字，越小越向前" class="layui-input"
                           type="number">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="status" value="1" title="启用"  <c:if test="${menu==null||menu.status==1}">checked="checked"</c:if> >
                    <input type="radio" name="status" value="0" title="停用"  <c:if test="${menu.status==0}">checked="checked"</c:if>>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
