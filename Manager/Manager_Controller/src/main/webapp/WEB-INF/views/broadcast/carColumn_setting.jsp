               ...
               <form  >
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input name="carId" autocomplete="off" value="${carColumn.carId}" lay-verify="number"
                                       placeholder="请输入汽车Id" class="layui-input" type="text">
                            </div>
                        </div>
                        <div class="layui-form-item">
                       ...
                       <div class="layui-input-inline">
                           <select name="columnId" value="${carColumn.columnId}" lay-verify="required">
                               ...
                               <c:forEach items="${columnList}" var="item">
                                   <option value="${item.key}" <c:if test="${carColumn.columnId==item.key}">selected="selected"</c:if>>${item.value}</option>
                               </c:forEach>
                           </select>
                       </div>
                   </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="radio" name="status" value="1" title="启用"  <c:if test="${carColumn==null||carColumn.status==1}">checked="checked"</c:if> >
                                <input type="radio" name="status" value="0" title="停用"  <c:if test="${carColumn.status==0}">checked="checked"</c:if>>
                            </div>
                        </div>
                        <div class="layui-form-item">
