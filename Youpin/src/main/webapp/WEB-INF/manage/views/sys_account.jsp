            ...
            <div class="list" v-show="handle=='list'">
                <div class="row blockquote">
                    <el-breadcrumb separator="/">
                        <el-breadcrumb-item><a @click="handle='list'">平台用户</a></el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <el-table :data="pageInfo.list" highlight-current-row
                        ...
                        <el-table-column prop="registtime" label="创建时间"width="200"></el-table-column>
                            ...
                            <el-card class="box-card" style="width: 500px"  v-loading="loading" element-loading-text="拼命加载中">
                                <el-form label-position="left" :model="form" ref="form" :rules="rules" label-width="120px"
                                    ...
                                    <el-form-item label="手机号" prop="phone">
                                        <el-input v-model="form.phone" :maxlength='11' style="width: 300px"></el-input>
                                    </el-form-item>
                                    <el-form-item>
        ...
        data:{
            ...
            handleCommand (command) {
               ...
               $.post('/system/account/list',this.searchForm,function(d){
                ...
                this.loading = true;
                $.getJSON('/system/account/status/'+row.id+'/'+row.status,function(d){
                    if(d.status==200){
                ...
                $.getJSON('/system/account/del/'+this.cur_index,function(d){
                    if(d.status==200){
                        VM.success();
                        VM.refrush();
                    }else{
                ...
                this.$refs['form'].validate(function(valid) {
                    if (valid) {
                        VM.loading = true;
                        $.post('/system/account/save',VM.form,function(d){
                            if(d.status==200){
