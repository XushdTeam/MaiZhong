            ...
            <div class="list" v-show="handle=='list'">
                ...
                <div class="row">
                    <el-table :data="pageInfo.list" highlight-current-row
                        ...
                        <el-table-column prop="company" label="所属店铺"width="200"></el-table-column>
                        <el-table-column prop="job" label="职务"width="200"></el-table-column>
                        <el-table-column prop="level" label="等级"width="100"></el-table-column>
                        <el-table-column prop="status" label="状态"width="100">
                            <template scope="scope">
                                <a href="javascript:;" v-if="scope.row.status" ><el-tag  type="success">可用</el-tag></a>
    ...
    var VM = new Vue({
        ...
        data:{
            ...
            handleCommand (command) {
               ...
               $.post('/system/user/list',this.searchForm,function(d){
                    if(d.status==200){
                        VM.pageInfo = d.data;
                    }else{
