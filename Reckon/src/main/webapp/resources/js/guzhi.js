...
function getSimpleList(a, b, c) {
    ...
    function d(a) {
        ...
        b.empty(), b.append(g), $("#select4").html("<div class='lable'>首次上牌时间:</div>请 选 择 年 份")
    }
 ...
 */
function getYears() {
    $("#select4").html("<div class='lable'>首次上牌时间:</div>请 选 择 年 份");
    var a = $("#s_year").val(),
        b = $("#s_simple").val(),
...
function resetAllHiddenInput() {
    ...
    $("#contact").attr("value", ""),
    $("#s_color").attr("value", "0"),
    $("#s_jxq").attr("value", "0"),
    $("#s_nj").attr("value", "0"),
    $("#s_xz").attr("value", "0"),
    $("#s_gh").attr("value", "0"),
    $("#s_ghtime").attr("value", "0"),
    $("#s_method").attr("value", "0"),
    $("#s_ck").attr("value", "0"),
...
$(function() {
    $("#select1").live("click", function() {
        ...
        closebg(), $("#select1").html('<div class="lable">选择车型:</div><div id="valnone"">' + a + "</div>").css("color", "#333"), $("#s_year").val("0"), $("#s_month").val("0"), getYears()
        ...
        var a = $(this).html();
        $("#s_year").val($(this).attr("id")), $("#s_month").val(0), $("#select4").html('<div class="lable">首次上牌时间:</div>'+a), getMonths(), $("#sele2_1,#sele2_2").fadeIn()
        ...
        $("#select4").html('<div class="lable">首次上牌时间:</div>'+a).css("color", "#333"), closebg()
