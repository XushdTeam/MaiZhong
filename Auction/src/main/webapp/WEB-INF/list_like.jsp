                        ...
                        <tr height="120" class="trhover">
                            ...
                            <td width="270px" class="pl10 pr10">
                                <div class="fs14 clearfix">
                                    <c:if test="${item.auction==true}">
                                        <a target="_blank" class="fl cblack" href="/list/check/report/${item.carId}/${item.auctionId}">
                                            <span class="fl carname" style="cursor: pointer">${item.modelName}</span>
                                        </a>
                                    </c:if>
                                    <c:if test="${item.auction==false}">
                            ...
                            <td>
                                ...
                                <c:if test="${item.auction==true}">
                                    <span class="fs16 ccheng ml10">竞拍中</span>
                                </c:if>
